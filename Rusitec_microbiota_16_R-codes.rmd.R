...
#Beta-diversity
#unifrac weighted
plot_ordination(Thomas_relabund, ordinate (Thomas_relabund, distance = "unifrac", method="PCoA"),
                "samples", color="Timepoint", shape="Phase") + xlab("PCoA 1 (35.7%)") + 
  ylab("PCoA 2 (11.9%)") + theme(legend.position="right") + theme_light() + 
  theme(legend.title=element_blank()) + geom_point(size = 2.5)

#unifrac_unweighted
plot_ordination(Thomas_relabund, ordinate (Thomas_relabund, distance = "uunifrac", method="PCoA"),
                "samples", color="Timepoint", shape="Phase") + xlab("PCoA 1 (35.7%)") + 
  ylab("PCoA 2 (11.9%)") + theme(legend.position="right") + theme_light() + 
  theme(legend.title=element_blank()) + geom_point(size = 2.5)
